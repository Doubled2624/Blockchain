...
<h1 align="center">
  ỨNG DỤNG BLOCKCHAIN TRONG NHẬN DIỆN PHƯƠNG TIỆN,<br>
  ƯỚC LƯỢNG TỐC ĐỘ XE VÀ XÁC THỰC DỮ LIỆU GIAO THÔNG
</h1>
...
Hệ thống **nhận diện phương tiện, ước lượng tốc độ xe và xác thực dữ liệu giao thông bằng Blockchain** là mô hình kết hợp giữa **xử lý ảnh**, **thị giác máy tính**, **trí tuệ nhân tạo** và **công nghệ Blockchain**.

Hệ thống sử dụng video giao thông hoặc camera làm đầu vào. Sau đó, mô hình **YOLO** được dùng để phát hiện phương tiện như ô tô, xe máy, xe tải và xe buýt. Khi phương tiện được phát hiện, thuật toán tracking sẽ gán ID riêng cho từng xe và theo dõi vị trí của xe qua nhiều khung hình để ước lượng tốc độ di chuyển.
...
Thuật toán tracking gán ID riêng cho từng xe, giúp hệ thống nhận biết cùng một phương tiện đang di chuyển qua nhiều khung hình khác nhau.
...
Sau đó hệ thống tạo mã băm từ bản ghi trên để phục vụ kiểm chứng.
...
Nếu chưa có file `requirements.txt`, có thể cài nhanh các thư viện cơ bản:
...
<p align="center"><em>Hình 1. Video giao thông đầu vào</em></p>
...
<p align="center"><em>Hình 2. Nhận diện phương tiện bằng YOLO</em></p>
...
<p align="center"><em>Hình 3. Theo dõi xe bằng ID</em></p>
...
<p align="center"><em>Hình 4. Ước lượng tốc độ xe</em></p>
...
<p align="center"><em>Hình 5. Cảnh báo phương tiện vượt tốc độ</em></p>
...
<p align="center"><em>Hình 6. Kết nối ví MetaMask</em></p>
...
<p align="center"><em>Hình 7. Ghi mã băm dữ liệu lên Blockchain</em></p>
...
<p align="center"><em>Hình 8. Kiểm chứng dữ liệu tốc độ xe</em></p>
